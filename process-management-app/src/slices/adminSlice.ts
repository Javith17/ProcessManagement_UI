...
export const fetchVendorDetail = createAsyncThunk("fetchVendorDetail", async (data:any) => {
    const response = await axiosInstance.get(`admin/vendor/${data}`, {
        headers: { 'Authorization': `Bearer ${JSON.parse(localStorage.getItem('userDetail') as string).accessToken}`}
    })
    const resData = response.data
    return resData
...
export const updateVendor = createAsyncThunk('updateVendor', async (data: any) => {
    const response = await axiosInstance.post('admin/updateVendor', data, {
        headers: { 'Authorization': 'Bearer ' + JSON.parse(localStorage.getItem("userDetail") as string).accessToken }
    })
    const resData = response.data.message
    return resData
...
export const fetchSupplierDetail = createAsyncThunk("fetchSupplierDetail", async (data:any) => {
    const response = await axiosInstance.get(`admin/supplier/${data}`, {
        headers: { 'Authorization': `Bearer ${JSON.parse(localStorage.getItem('userDetail') as string).accessToken}`}
    })
    const resData = response.data
    return resData
...
export const fetchCustomerDetail = createAsyncThunk("fetchCustomerDetail", async (data:any) => {
    const response = await axiosInstance.get(`admin/customer/${data}`, {
        headers: { 'Authorization': `Bearer ${JSON.parse(localStorage.getItem('userDetail') as string).accessToken}`}
    })
    const resData = response.data
    return resData
...
export const updateCustomer = createAsyncThunk('updateCustomer', async (data: any) => {
    const response = await axiosInstance.post('admin/updateCustomer', data, {
        headers: { 'Authorization': 'Bearer ' + JSON.parse(localStorage.getItem("userDetail") as string).accessToken }
    })
    const resData = response.data.message
    return resData
